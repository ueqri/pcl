...
function(PCL_CUDA_ADD_LIBRARY _name)
  ...
  if(PCL_SHARED_LIBS)
    target_compile_options(${_name} PRIVATE -Wall -fopenmp-simd -fpermissive -DPCLAPI_EXPORTS)
  else()
    target_compile_options(${_name} PRIVATE -Wall -fopenmp-simd -fpermissive)
  endif()
  target_link_libraries(${_name} dl tbb Threads::Threads)
